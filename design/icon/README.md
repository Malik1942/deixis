...
The shipped icon is `Locant/AppIcon.icon` (Icon Composer package; Xcode composes it for macOS 26 and the
...
- Render any package through Apple's engine (same one macOS 26 uses):
  `"/Applications/Xcode.app/Contents/Applications/Icon Composer.app/Contents/Executables/ictool" Locant/AppIcon.icon --export-image --output-file out.png --platform macOS --rendition Default --width 1024 --height 1024 --scale 1`
