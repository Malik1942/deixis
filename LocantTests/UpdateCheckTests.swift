...
final class UpdateCheckTests: XCTestCase {
    ...
    {
      "url": "https://api.github.com/repos/Malik1942/locant/releases/1",
      "html_url": "https://github.com/Malik1942/locant/releases/tag/v0.7",
      "tag_name": "v0.7",
      "name": "Locant 0.7.0",
      "draft": false,
      "prerelease": false,
      "assets": [
        {
          ...
          "size": 3818682,
          "download_count": 12,
          "browser_download_url": "https://github.com/Malik1942/locant/releases/download/v0.7/Locant.dmg"
        }
      ],
      "body": "Notes"
    }
    ...
    func testReleaseDecoding() throws {
        ...
        XCTAssertEqual(release.downloadURL.absoluteString, "https://github.com/Malik1942/locant/releases/download/v0.7/Locant.dmg")
    }

    // 4
    func testReleaseWithoutDmgOpensThePage() throws {
        let json = """
        {"tag_name": "v0.7", "html_url": "https://github.com/Malik1942/locant/releases/tag/v0.7", "assets": [{"name": "notes.txt", "browser_download_url": "https://example.com/notes.txt"}]}
        """.data(using: .utf8)!
        let release = try GitHubRelease.decode(json)
        XCTAssertEqual(release.downloadURL.absoluteString, "https://github.com/Malik1942/locant/releases/tag/v0.7")
    }
    ...
    func testUnparsableTagIsUpToDate() throws {
        let json = """
        {"tag_name": "nightly", "html_url": "https://github.com/Malik1942/locant/releases", "assets": []}
        """.data(using: .utf8)!
        let release = try GitHubRelease.decode(json)
    ...
    func testRequestCarriesOnlyTheVersion() {
        ...
        XCTAssertEqual(request.value(forHTTPHeaderField: "User-Agent"), "Locant/0.6.0")
