...
/// the frontmost app does and can swallow it, so a chord fires Deixis alone and never also reaches
/// Xcode. Needs Accessibility trust, which Deixis already requires; without it `init` fails and
