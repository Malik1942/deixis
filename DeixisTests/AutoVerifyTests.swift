...
final class AutoVerifyTests: XCTestCase {
    private func capture(mode: CaptureMode = .fix, bundleId: String = "com.inspireocean.app", createdAt: String = "2026-09-14T18:00:00+08:00",
        ...
        var c = Capture(
            ...
            image: ImageInfo(path: "/tmp/deixis-oryne-20260914-180000-ab12.png", widthPt: 10, heightPt: 10, scale: 2, crop: nil),
    ...
    func testComparesWithTheNewestImage() {
        XCTAssertEqual(AutoVerify.previousImagePath(of: capture()), "/tmp/deixis-oryne-20260914-180000-ab12.png")
