...
final class IterationStoreTests: XCTestCase {
    func testAppendRoundTripsAndNamesAfterImages() throws {
        let dir = FileManager.default.temporaryDirectory.appending(path: "DeixisVerify-\(UUID().uuidString)")
        defer { try? FileManager.default.removeItem(at: dir) }
        try FileManager.default.createDirectory(at: dir, withIntermediateDirectories: true)
        let sidecar = dir.appending(path: "deixis-simulator-20260913-180000-ab12.json")
        var capture = Capture(
            id: "20260913-180000-ab12", createdAt: "2026-09-13T18:00:00-07:00", mode: .fix,
            image: ImageInfo(path: dir.appending(path: "deixis-simulator-20260913-180000-ab12.png").path(percentEncoded: false), widthPt: 10, heightPt: 10, scale: 2, crop: nil),
        ...
        XCTAssertEqual(IterationStore.afterImageURL(for: sidecar, index: 1).lastPathComponent, "deixis-simulator-20260913-180000-ab12-after-1.png")
